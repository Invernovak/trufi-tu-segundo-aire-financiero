...
export const contactFormPensionadoSchema = baseContactSchema;

// Contact form validation schema for Docente page (includes institucion field)
export const contactFormDocenteSchema = baseContactSchema.extend({
  institucion: z
    .string()
    .trim()
...
export const footerContactFormSchema = baseContactSchema;
