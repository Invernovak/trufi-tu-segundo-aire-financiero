...
const TrufiPlus = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-0">
        {/* Hero Section */}
        <section className="relative min-h-screen pt-20 pb-12 md:pt-28 md:pb-20 flex items-center justify-center bg-gradient-to-br from-secondary/10 to-background">
