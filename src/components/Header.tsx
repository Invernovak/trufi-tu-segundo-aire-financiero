...
const Header = () => {
  ...
  const forceSolidHeader = location.pathname === "/blog";
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled || forceSolidHeader
    ...
    >
      <div className="container mx-auto flex items-center justify-between h-auto flex-nowrap px-4 md:px-8 max-w-[1250px]">
        ...
        <nav className="hidden xl:flex items-center lg:gap-3 xl:gap-5">
          ...
          {/* Productos Dropdown */}
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-1 text-white/90 hover:text-emerald-400 transition-colors font-medium lg:text-[13px] xl:text-[14px] outline-none text-shadow-sm whitespace-nowrap">
              Productos
          ...
          <Link
            to="/zona-pagos"
            className="text-white/90 hover:text-emerald-400 transition-colors font-medium lg:text-[13px] xl:text-[14px] flex items-center gap-1 text-shadow-sm whitespace-nowrap"
          >
            Ponte Al Día
          </Link>
